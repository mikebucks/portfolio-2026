    ...
    >
      ...
      <div className="mx-auto max-w-[1600px] pt-10 pb-24">
        ...
        <div className="max-w-4xl space-y-6 text-lg leading-relaxed text-white/90">
          <p>High impact IC with a builder's mindset. I <strong>design</strong>, <strong>build</strong>, and <strong>grow</strong> digital products. A natural systems thinker, I love connecting design systems, code, usage metrics, and research. I'm equally comfortable crafting UIs, interviewing customers, mapping business processes, shipping production code, or prototyping feature ideas.</p>
